...
if __name__ == "__main__":
    ...
    with tf.Session(config=config) as sess:
        ...
        input_img = sess.graph.get_tensor_by_name("Placeholder:0")  #输入节点
        wordlist = sess.graph.get_tensor_by_name("AttentionOcr_v1/predicted_chars:0") #输出节点
        ...
        export_path = '/data/liuyan/ocr_model/ttf-wpai-serving-driving-vin'
        ...
        signature_def_map = {
            "ocr_vin_image": tf.saved_model.signature_def_utils.build_signature_def(  #模型导出时签名参数
