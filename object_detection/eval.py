...
flags.DEFINE_string('checkpoint_dir', '/data/liuyan/car_plate/object_faste_rcnn_model/',
                    'Directory containing checkpoints to evaluate, typically '
                    'set to `train_dir` used in the training job.')
flags.DEFINE_string('eval_dir', '/data/liuyan/identitycard/model/eval_logs',
                    'Directory to write eval summaries to.')
flags.DEFINE_string('pipeline_config_path', '/home/liuyan/models/research/object_detection/samples/configs/faster_rcnn_inception_v2_pets.config',
